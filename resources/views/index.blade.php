...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center">
        <h2 class="text-center">Halo {{ session('username') }}!
            <br>Selamat Datang di Game Edukasi Pengenalan Rumah Adat dan Aksara Lontara
        </h2>
    </div>
            ...
            <li>
                <a href="{{ route('level') }}">
                    <label class="start-quiz-item">
                        ...
                        <span class="exp-label">Play</span>
            ...
            <li>
                <a href="{{ route('exit') }}">
                    <label>
                        ...
                        <span class="exp-label">Exit</span>
                        <span class="checkmark-border"></span>
                    </label>
                </a>
            </li>
